%ifdef CONFIG
{
  "RegData": {
      "RAX": ["2"],
      "RDX": ["7"],
      "XMM0": ["0x00060F000F000D01", "0x0000040404070007"],
      "XMM1": ["0x3111313131311111", "0x0039191111313131"],
      "XMM2": ["0xAABBCCDDEE0002FE", "0x2233445566778899"],
      "XMM3": ["0x004103FFFD807F01", "0x778899AABBCCDDEE"]
  },
  "HostFeatures": ["SSE4.2"]
}
%endif
