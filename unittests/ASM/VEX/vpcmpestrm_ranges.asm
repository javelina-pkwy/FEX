%ifdef CONFIG
{
  ...
  "RegData": {
      "RAX":   ["3"],
      "RDX":   ["16"],
      "XMM1":  ["0x3111313131311111", "0x0000000011313131", "0x0000000000000000", "0x0000000000000000"],
      ...
      "XMM15": ["0x0000000000008070", "0x0000000000000000", "0x0000000000000000", "0x0000000000000000"]
  }
}
%endif
