%ifdef CONFIG
{
  "HostFeatures": ["AVX"],
  "RegData": {
      "XMM0": ["0x04060F000F000D07", "0x0202011001040407", "0x0000000000000000", "0x0000000000000000"],
      "XMM1": ["0x1939313131311111", "0x1919191011191919", "0x0000000000000000", "0x0000000000000000"],
      "XMM2": ["0xAABBCCDDEE0080FF", "0x2233445566778899", "0x0000000000000000", "0x0000000000000000"],
      "XMM3": ["0xEE00646380FF6261", "0x66778899AABBCCDD", "0x0000000000000000", "0x0000000000000000"]
  }
}
%endif
...
vmovaps xmm2, [rel .data_vowels]
vmovaps xmm3, [rel .data_hi]
; Short string with set members past the null terminator (lsb)
CompareAndStore 13, 0b00000000

vmovaps xmm2, [rel .data_highbits]
vmovaps xmm3, [rel .data_highbits_str]
